$(document).ready(function () {
  ...
  var oTable = $(".dataTables-tbl_pruebasl").dataTable();
  ...
  $("#guardar").click(function () {
    ...
    if (campoRequerido) {
      ...
      formData.append("puntuacion", $("#puntuacion").val());
      ...
      $.ajax({
        type: "POST",
        url: "../../controller/prueba/controller_prueba.php?opcion=1",
        data: formData,
        processData: false,
        contentType: false,
...
function limpiarCampos() {
  $("#nombrePregunta").val(""); // Limpiar el campo con ID "numero"
  $("#fecha").val(""); // Restablecer la selección del programa a la opción predeterminada
  $("#puntuacion").val(""); // Restablecer la selección del estado a la opción predeterminada
  $("#objetivos").val(""); // Desmarcar la casilla de verificación
  $("#indicaciones").val("");
  $("#descripcion").val("");
  $("#estado").val("");
  $("#guardar").show();
